                    ...
                    <CarouselItem key={index} className="w-[900px] h-[334px]">
                        <div className="p-1 w-full h-full">
                            <Card className="h-full flex flex-col relative">
                                ...
                                <CardContent className="flex flex-row items-center justify-between h-full relative">
                                    ...
                                    <div className="w-2/3 pr-4">
                                        ...
                                        <div className="h-[149px] text-black text-[28px] font-normal ">This app helped  
                                             me brrrrrrrrrrrrrrrrrrrrrrrrr erbrtebw wefdw f wd fwdfwdf w dwf wd fwf wdf wdf wdf wdf wdf wdf wd wd wdf wd wdf w wdf wf dw wd fwd </div>
                                    </div>
                                ...
                                <div className="absolute bottom-0 left-11 right-1 w-[90%] center h-[270px]  bg-[#cfecff]/40 z-[-1]"></div>
                            </Card>
                        </div>
                    </CarouselItem>
                ))}
